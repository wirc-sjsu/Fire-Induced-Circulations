...
start_point = CoordPair(lat=34.65, lon=-118.80)
end_point = CoordPair(lat=34.24, lon=-119.45)
# %%
######################################
#Get data
...
# Create the start point and end point for the cross section
    for tidx in range(len(time)):
        ...
        # cmar_ax = fig.add_axes([0.91, 0.15, 0.04, 0.7])
        # pl = plt.colorbar(im, cax=cmar_ax)
        # pl.set_label('Vertical Wind Speed (m/s)', fontsize = 18, fontweight = 'bold')
        # pl.ax.tick_params(labelsize=15)
        ...
        x_labels = ['34.65, -118.80','34.60, -118.87', '34.55, -118.95', '34.50, -119.03', '34.45, -119.10', '34.40, -119.18', '34.35, -119.25', '34.30, -119.33', '34.25, -119.40']
