...
for f in range(len(sdir)):
    ...
    ht_surf = interplevel(z, pres, 629).data
    ...
    ht_surf1 = interplevel(z1, pres2, 629).data
...
#plt.ylim(0,5)
plt.title('Min Surface Geopotential Height Difference Around Active Fire (GRNHFX > 0) \nOver Time for the Creek Fire (Fire vs. No Fire)')
plt.xlabel('Time (UTC)')
